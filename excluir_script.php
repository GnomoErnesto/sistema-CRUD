        ...
        <div class="container">
            <div class="row">
                ...
                include "conection.php";
                    ...
                    mensagem("$nome Não Excluiu!",'danger');
                    
                ?>

              </div>
            <a href="cadastro.php" class="btn btn-primary">Voltar Para Cadastro</a>
            <a href="index.php" class="btn btn-primary">Voltar Para Inicio</a>
            <a href="pesquisar.php" class="btn btn-primary">Voltar Para Pesquisa</a>
          </div>
